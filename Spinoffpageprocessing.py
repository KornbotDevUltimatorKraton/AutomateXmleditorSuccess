...
input1 = PdfFileReader(open(PATHMAIN+"/"+"drv8212.pdf", "rb"))  #using oslist dir readding the file and extract all the value in the loop 
inputcomp = "drv8212" # Get the component input data 
                                               ...
                                               for rik in range(0,len(packageout)):
                                                       ...
                                                       if percent.ratio()*100 == 100:
                                                               ...
                                                               if drawing.find('library').find('symbols'):
                                                                   ...
                                                                   """
                                                                   #Running gate input
                                                                   print("Key gate connection")
                                                                   for irl in range(0,len(Gateconnect)):
                                                                          try:
                                                                            print(key3_gate[vav3_gate.index(Gateconnect[irl])])
                                                                          except:
                                                                               vav3_gate[irl] = Gateconnect[irl]
                                                                   print(vav3_gate)
                                                                   
                                                                   for irk in range(0,len(Gateconnect)):
                                                                            print(Gateconnect[irk],key3_gate[vav3_gate.index(Gateconnect[irk])])
                                                                            Connectsrecord[key3_gate[vav3_gate.index(Gateconnect[irk])]] = Gateconnect[irk] #Making new conneciton pins record      
                                                                   
                                                                   
                                                                   print("Getting new connection record",Connectsrecord)              
                                                                   key_connect = list(Connectsrecord.keys())
                                                                   vav_connect = list(Connectsrecord.values())
                                                                   for gates in drawing.find('library').find('devicesets').iter('connect'):
                                                                                 print(gates.attrib)
           ...
           for il in range(0,len(listrecorder)):
                       ...
                       if checkpackage !=[]: 
                              ...
                              if percent.ratio()*100 >= 85.71428571428571 and percent.ratio()*100 <= 100.0: 
                                       ...
                                       print(Packageorder) #Getting the list of the package order for the device have morethan 1 package data
                                       #"""
                                       for ij in range(0,len(Deviceindexheader)): #Getting the device name pack combine with drawing package for search package  
                                                 ...
                                                 #fullnamedevice = DevicenamePackful+rearrangedata
                                                 #Packagematch = Packageorder.get(fullnamedevice)
                                                 #print("Drawing combine pack name",DevicenamePackful) #Getting the name of the drawing combine 
                                                 #print("Package match found:",DevicenamePackful,Packagematch) #Package match found in the in the list
                                       #"""
                       ...
                       if checkpackage !=[]: 
                              ...
                              if percent.ratio()*100 >= 85.71428571428571 and percent.ratio()*100 <= 100.0: 
                                       ...
                                       print(Packagedevice) #Getting the data of the package device 
                                       ...
                                       for ik in range(0,len(key_val)):
                                               if len(key_val) <= 1:
                                                    ...
                                                    print(checkintersec)
                                                    #"""
                                                    if Packagedrawing[len(Packagedrawing)-1] == "".join(checkintersec):
